...
function() {
    ...
    function l(t) {
        var e = n({},
        this.defaults.animation, t.animation);
        this.init(n({},
        this.defaults, t, {
            animation: e
        }))
    ...
    return l.prototype = {
        ...
        init: function(t) {
            ...
            this.initCanvas(t),
            this.initEvents(t),
            t.items.length && t.items.forEach(function(i) {
        ...
        initOptions: function(t) {
            ...
            r(t, ["items", "image", "text", "path", "w", "h", "tx", "ty", "piecesWidth", "piecesSpacing", "extraSpacing", "angle", "rotate", "translate", "svgWidth", "svgHeight", "color", "backgroundColor", "backgroundRadius", "padding", "opacity", "fontFamily", "fontSize", "fontWeight", "ghost", "ghostOpacity"]),
        ...
        setItemOptions: function(t, e) {
            ...
            h(t, i, ["text", "color", "backgroundColor", "backgroundRadius", "padding", "fontFamily", "fontSize", "fontWeight", "svgWidth", "svgHeight", "piecesWidth", "piecesSpacing", "extraSpacing", "opacity", "angle", "rotate", "translate", "ghost", "ghostOpacity", "w", "h", "tx", "ty"], this.v),
        ...
        initImage: function(t) {
            ...
            e.backgroundColor && (r.fillStyle = e.backgroundColor, e.backgroundRadius ? (f(r, 1, 1, a.width - 2, a.height - 2, e.backgroundRadius), r.fill()) : r.fillRect(1, 1, a.width - 2, a.height - 2)),
            r.drawImage(t, 0, 0, t.naturalWidth, t.naturalHeight, 1 + i[3], 1 + i[0], t.width, t.height),
        ...
        initText: function(t) {
            ...
            r.height = n + i[0] + i[2],
            e.backgroundColor && (h.fillStyle = e.backgroundColor, e.backgroundRadius ? (f(h, 1, 1, r.width - 2, r.height - 2, e.backgroundRadius), h.fill()) : h.fillRect(1, 1, r.width - 2, r.height - 2)),
            h.textBaseline = "bottom",
            h.font = e.fontWeight + " " + n + "px " + e.fontFamily,
            h.fillStyle = e.color,
        ...
        initPieces: function(e) {
            ...
            0) + x * this.drawList.length) / 2 : e.x,
            m = "center" === e.y ? this.height / 2 - this.drawList[0].height / 2 : e.y;
            var y = void 0;
            this.drawList.forEach(function(t, w) {
                ...
                for (M.width = s.width, M.height = s.height; l - (s.width + 2 * S) < s.x;) {
                    ...
                    r = s.height + 2 * _,
                    h = g.fnc(y.piecesSpacing) ? y.piecesSpacing() : y.piecesSpacing,
                    ...
                    E.drawImage(s.img, (1 - O) / 2, O / 2, s.img.width - (1 - O), s.img.height - O),
                    E.restore()
                }
                s.imgShown = M,
                s.rectShown = {
        ...
        renderPieces: function(e, i) {
            ...
            i.redraw && (i.redraw = !1, i.shown && e.saveShowState ? n.drawImage(i.imgShown, 0, 0, i.width, i.height, i.x, i.y, i.width, i.height) : i.hidden || (o = u(i.angle), r = u(i.rotate), i.pieces.forEach(function(t) {
                ...
                e.debug ? (n.setLineDash([]), n.strokeStyle = "black", n.stroke()) : n.clip(),
                a.translate( - (t.x + t.w / 2 - i.x), -(t.y + t.h / 2 - i.y)),
                a.translate(i.width / 2, i.height / 2),
                ...
                n.drawImage(i.img, (1 - h) / 2, h / 2, i.img.width - (1 - h), i.img.height - h),
                a.reset(),
                n.restore()
            })))
        },
        ...
        clearRect: function(e) {
            ...
            for (this.items.forEach(function(t) {
                b = u(t.angle),
                S = u(t.rotate),
                i.isItemDifferent(t) ? (a = !0, w = null, t.redraw = !0, t.shown = i.isItemShown(t), t.hidden = i.isItemHidden(t), c(t.last, t, ["angle"]), t.pieces.forEach(function(e) {
                    var a = e.last;
                    n.translate(t.x, t.y),
                    ...
                    n.reset(),
                    c(a, e, ["x", "y", "w", "h", "tx", "ty"])
                }), _ = i.extendRect(_, w), t.rect = t.shown ? t.rectShown: w) : t.redraw = !1,
                t.hidden && t.ghost && (a = !0, _ = i.extendRect(_, t.rectShown))
            }); a;) a = !1,
            this.items.forEach(function(t) { ! t.redraw && d(_, t.rect) && (a = !0, t.redraw = !0, _ = i.extendRect(_, t.rect))
            });
        ...
        checkHover: function(t, e) {
            ...
            return i && !e.hover ? g.fnc(t.itemEnter) && t.itemEnter(e) : !i && e.hover && g.fnc(t.itemLeave) && t.itemLeave(e),
            e.hover = i,
            i
        },
        ...
        animatePieces: function(t) {
            ...
            e.ignore && e.ignore.forEach(function(t) {
                return delete e[t]
            }),
        ...
        animateItems: function(t) {
            ...
            e.remove && anime.remove(e.targets),
            anime(e)
        }
    },
    l.version = "1.0.0",
